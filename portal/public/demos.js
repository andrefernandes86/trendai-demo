...
window.TRENDAI_DEMOS = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Trigger Host IPS — cycles through real exploit signatures (SQLi + browser RCE PoCs) with their actual TippingPoint rule IDs.',
    ...
    note: 'All detections run locally inside the container against bundled test artifacts (EICAR + real TippingPoint IPS test samples) — no live external requests at demo time.',
  },
  {
    id: 'smish',
    category: 'Other',
